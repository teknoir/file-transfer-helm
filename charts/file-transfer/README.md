# File Transfer Helm Chart

This chart deploys File Transfer App to a Kubernetes cluster.
...
metadata:
  ...
  namespace: default
spec:
  repo: https://teknoir.github.io/file-transfer-helm
  chart: file-transfer
...
streams:
  # CLIP, ANNOTATION GENERATION AND TRANSFER
  - stream: prepare-file
  - stream: transfer-file
```
...
```bash
helm repo add teknoir-file-transfer https://teknoir.github.io/file-transfer-helm/
```

## Installing the chart

```bash
helm install file-transfer teknoir-file-transfer/file-transfer values.yaml
```